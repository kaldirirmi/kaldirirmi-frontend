...
; (function (global, factory) {
  ...
  var defaultLocaleMonths = 'Ocak_Subat_Mart_Nisan_Mayis_Haziran_Temmuz_Agustos_Eylul_Ekim_Kasim_Aralik'.split('_');
  ...
  var defaultLocaleMonthsShort = 'Oca_Sub_Mar_Nis_May_Haz_Tem_Agu_Eyl_Eki_Kas_Ara'.split('_');
  ...
  var defaultLocaleWeekdays = 'Pazar_Pazartesi_Sali_Carsamba_Persembe_Cuma_Cumartesi_Pazar'.split('_');
  ...
  var defaultLocaleWeekdaysShort = 'Paz_Pts_Sal_Car_Per_Cum_Cts'.split('_');
  function localeWeekdaysShort(m) {
    return (m) ? this._weekdaysShort[m.day()] : this._weekdaysShort;
  }

  var defaultLocaleWeekdaysMin = 'Pz_Pt_Sa_Ca_Pe_Cu_Ct'.split('_');
  ...
  function toString() {
    return this.clone().locale('tr').format('ddd MMM DD YYYY HH:mm:ss [GMT]ZZ');
  }
  ...
  var en = moment__default.defineLocale('en', {
    months: 'Ocak_Subat_Mart_Nisan_Mayis_Haziran_Temmuz_Agustos_Eylul_Ekim_Kasim_Aralik'.split('_'),
